...
class ProdukMetodeController extends Controller
{
    public function index()
    {
        $produkmetode = ProdukMetode::orderBy('id', 'asc')->get();
        $total = ProdukMetode::count();
        return view('admin.produk.metode.home', compact(['produkmetode','total']));
    }
